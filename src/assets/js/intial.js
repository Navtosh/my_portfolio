...
var $grid = $('.grid').isotope({
  ...
  $('.portfolio_filter').on( 'click', 'a', function() {
  ...
  $('.portfolio_filter').each( function( i, buttonGroup ) {
...
function news_popup(){
	...
	var modalBox		= jQuery('.modalbox');
	var button			= jQuery('.news .list_inner .full_link,.news .news_list ul li .details .title a,.news .learn_more a');
	var closePopup		= modalBox.find('.close');
